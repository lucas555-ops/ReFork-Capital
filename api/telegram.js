...
<section id="apply" class="py-24 text-center relative">
  <div class="max-w-3xl mx-auto px-6">
    ...
    <form id="leadForm"
      ...
      <!-- ОБНОВЛЕННЫЙ БЛОК TELEGRAM С ВАЛИДАЦИЕЙ -->
      <div class="relative">
        ...
        <div class="relative">
          <input type="text" id="telegram" name="telegram" required
                 ...
                 class="w-full bg-gray-900 border border-white/20 rounded-lg px-4 py-2 pr-10 focus:border-cyan-400 focus:outline-none text-gray-100 placeholder-gray-500 transition-colors"
                 placeholder="@username">
          <!-- Иконка валидации -->
          <div class="absolute right-3 top-1/2 -translate-y-1/2 hidden" id="telegram-valid-icon">
            <svg class="w-5 h-5 text-green-400" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
            </svg>
          </div>
          <div class="absolute right-3 top-1/2 -translate-y-1/2 hidden" id="telegram-invalid-icon">
      ...
      <div class="text-center pt-4">
        <button type="submit" id="leadSubmit"
                class="bg-gradient-to-r from-teal-400 to-cyan-400 text-black font-bold px-8 py-4 rounded-xl hover:scale-105 transition-transform w-full md:w-auto inline-flex items-center justify-center">
